...
const ACTIVITY_PROFILE_EXTRA_FIELDS: Record<ConcreteActivityProfile, readonly string[]> = {
  ...
  "act-016": ["categoryLabels", "wordBank"],
  "act-017": ["body", "correctAnswer"],
  "act-018": ["body", "correctAnswer", "wordBank"],
  "act-019": ["body", "correctAnswer"],
  "act-020": ["audioPrompt"],
  "act-021": ["audioPrompt", "choiceElements"],
  "act-022": ["audioPrompt"],
  "act-023": ["buttons"],
  "act-024": ["audioPrompt"],
  "act-025": ["correctOrderWords", "lines"],
  "act-026": ["audioPrompt"],
};
